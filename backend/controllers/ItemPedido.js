...
const service = require('@services/ItemPedido');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'ItemPedido::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'ItemPedido::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'ItemPedido::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'ItemPedido::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'ItemPedido::destroy', error);
    }
};
