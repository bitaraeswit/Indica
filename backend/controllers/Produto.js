...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Produto::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Produto::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Produto::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Produto::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Produto::destroy', error);
    }
};
