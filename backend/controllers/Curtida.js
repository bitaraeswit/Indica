...
const service = require('@services/Curtida');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Curtida::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Curtida::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Curtida::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Curtida::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Curtida::destroy', error);
    }
};
