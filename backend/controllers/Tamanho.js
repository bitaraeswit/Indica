...
const service = require('@services/Tamanho');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Tamanho::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Tamanho::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Tamanho::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Tamanho::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Tamanho::destroy', error);
    }
};
