...
const service = require('@services/EnderecoLoja');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'EnderecoLoja::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'EnderecoLoja::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'EnderecoLoja::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'EnderecoLoja::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'EnderecoLoja::destroy', error);
    }
};
