...
const service = require('@services/Notificacao');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Notificacao::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Notificacao::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Notificacao::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Notificacao::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Notificacao::destroy', error);
    }
};
