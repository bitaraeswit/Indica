...
const service = require('@services/StatusPedido');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'StatusPedido::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'StatusPedido::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'StatusPedido::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'StatusPedido::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'StatusPedido::destroy', error);
    }
};
