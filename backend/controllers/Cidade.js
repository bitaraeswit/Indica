...
const service = require('@services/Cidade');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Cidade::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Cidade::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Cidade::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Cidade::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'Cidade::destroy', error);
    }
};
