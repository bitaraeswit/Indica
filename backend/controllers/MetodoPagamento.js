...
const service = require('@services/MetodoPagamento');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'MetodoPagamento::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'MetodoPagamento::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'MetodoPagamento::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'MetodoPagamento::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'MetodoPagamento::destroy', error);
    }
};
