...
const service = require('@services/TamanhoProduto');
...
const index = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'TamanhoProduto::index', error);
    }
};
...
const show = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'TamanhoProduto::show', error);
    }
};
...
const store = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'TamanhoProduto::store', error);
    }
};
...
const update = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'TamanhoProduto::update', error);
    }
};
...
const destroy = async (req, res) => {
    try {
        ...
        return responseErrorJson(res, 'TamanhoProduto::destroy', error);
    }
};
