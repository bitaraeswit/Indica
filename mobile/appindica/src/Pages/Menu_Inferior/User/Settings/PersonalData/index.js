...
function PersonalData() {
  ...
  const [selectedValueCidade, setSelectedValueCidade] = useState("0");
  ...
  useEffect(() => {
    ...
    data.map(item => {
      if (item.sigla === selectedValue) {
        setSelectedCity(item.cidades);
      }
    });
  }, [selectedValue]);
        ...
        <County>
          ...
          <City>
            <Picker
              ...
              enabled={disabledCity}
              style={{ height: 50, width: "100%", color: "rgba(0, 0, 0, 0.3)" }}
              onValueChange={(itemValue1, itemIndex1) =>
                setSelectedValueCidade(itemValue1)
              }
            >
